...
import { addDocWithAutoID, deleteADoc, getAllDocs, setDocWithID } from "../firebase/firestore/client";
		...
		if (navItem.level === 1) {
			...
			if (typeof lev2Pos === "number" && typeof lev1Pos === "number") {
				...
				if (lev2Items) {
					...
					await setDocWithID(`navItems/${navItems[lev1Pos].id}`, navItems[lev1Pos]);
					setNavItems([...navItems]);
				}
			}
		}
	...
	return (
		<>
			...
			<Menu
				...
				setOpenMenuSlideOver={setOpenMenuSlideOver}></Menu>
		</>
	);
};
